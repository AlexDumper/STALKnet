...
- **Тёмная тема** — цветовая схема в стиле "матрицы"
...
Версия приложения отображается в заголовке рядом с названием: **STALKnet v0.1.X**

Автоматическое обновление версии происходит при использовании скрипта `.\scripts\build.ps1` — PATCH-версия увеличивается на 1.
